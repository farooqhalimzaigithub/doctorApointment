...
<head>
    ...
    <title>Doctors Apointment</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="images/favicon.png">
    <!-- Pignose Calender -->
    <!-- <link href="{{asset('admin_assets/plugins/pg-calendar/css/pignose.calendar.min.css')}}" rel="stylesheet"> -->
    <!-- Chartist -->
    <!-- <link rel="stylesheet" href="{{asset('admin_assets/plugins/chartist/css/chartist.min.css')}}"> -->
    <!-- <link rel="stylesheet" href="{{asset('admin_assets/plugins/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css')}}"> -->
    <!-- Custom Stylesheet -->
